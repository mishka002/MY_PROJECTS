...
jQuery(function ($) {
    ...
    if (supportsAudio) {
        ...
        var index = 0,
            ...
            tracks = [{
                "track": 1,
                "name": "გია ყანჩელი - ყვითელი ფოთლები",
                "duration": "2:46",
                "file": "Gia_YancheliYellowLeaves"
            }, {
                "track": 2,
                "name": "გია ყანჩელი - ჩემი ქალაქი",
                "duration": "8:30",
                "file": "Giya Kancheli - Chemi Qalaqi  გია ყანჩელი - ჩემი ქალაქი"
            }, {
                "track": 3,
                "name": "chopin - nocturne op9 no2",
                "duration": "4:29",
                "file": "chopin_nocturne_op9_no2"
            }, {
                "track": 4,
            ...
            audio = $('#audio1').on('play', function () {
                playing = true;
                npAction.text('მოუსმინე...');
            }).on('pause', function () {
                playing = false;
                npAction.text('გაჩუმდი...');
            }).on('ended', function () {
